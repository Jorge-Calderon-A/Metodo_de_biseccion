...
% func= FUNCIÓN A EVALUAR Y APLICAR EL METODO

%x_lower= El valor bajo la bisección

%x_upper= El mayor valor de la bisección

%error= Valor del error maximo que acepta el metodo, es decir, en cuantos
%digitos queremos que tenga el error.

%max_iteration= Valor del numero de iteraciones, es IMPORTANTE SABER QUE ES
%POSIBLE QUE MIENTRAS MAS ITERACIONES, MENOS ERROR.
